...
/**
 * Función para registrar un nuevo tipo de taxonomía para un custom postst
 * Función creada por pardomalfanti
 * @param  string $sitio nombre del sitio
 * @param  string $name  Nombre de la nueva taxonomía [se ve en el panel]
 * @param  string $type  Nombre del custom post type
 * @param  string $slug  slug de la nueva taxonomía
 */
